...
This is a fork of Triq that is being run under the
[[https://rfc.zeromq.org/spec:22][ZeroMQ collaboration rules]] with the one
exception being that it is under the Apache license.
